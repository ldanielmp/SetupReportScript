...
REM Modify date 10/28/2020
REM Version 1.23
REM Author: Leonard.Severt@microsoft.com

REM - Add command line parameters - Done
REM - Really fix /Q dir output - Done
REM - Add dump config info to _reg_Recovery.TXT - Done
REM - Change %windir%\system32\MDMDiagnosticsTool.exe -area Autopilot;DeviceEnrollment;Tpm -cab "%_TEMPDIR%\MDMDiag\AutopilotDeviceEnrollmentTpmDiag.cab" >NUL 2>>NUL - Done
REM - Add keyboard info to reg_recovery output - Done
REM - Get HKLM\Software\microsoft\windows\currentversion\oobe - Done get as part of Windows Update files
REM - Get txt version of Microsoft-Windows-Store/Operational - Done
REM - If Surface device always get battery report - Done
REM - If c:\WindowsUpdateVerbose.etl exist copy it - Done added to Windows Update section
REM - Get selected folder for System32\Logfiles - Done only get wmi and setupcln
REM - Get sigverif.txt file if it exist
REM - Add dir of Program Files (Arm) for app compat on WOA - Done
REM - Get \windows.old\windows\logs\mosetup\UpdateAgent.log - Done
...
REM set _FOLDERNAME=Setup_Report_%COMPUTERNAME%
...
Echo SetupReport Version is 1.23 > %_PREFIX%MiscInfo.txt
...
IF EXIST %windir%\system32\MDMDiagnosticsTool.exe (
    ...
    %windir%\system32\MDMDiagnosticsTool.exe -out %_TEMPDIR%\MDMDiag\ >NUL 2>>NUL
